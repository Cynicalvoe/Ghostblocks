	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args){
		if(cmd.getName().equalsIgnoreCase("gb")){
			if(args.length==1){
				...
				sender.sendMessage("§a==========[ §f§ki§e§l Ghostblocks Help §cv"+version+" §f§ki§a ]==========");
				sender.sendMessage("§e§l> §8/gb get§7 - Get a Ghostdrop");
				sender.sendMessage("§e§l> §8/gb reset [radius] §7 - Remove all Ghostblocks");
				sender.sendMessage("§e§l> §8/gb reload §7 - Reload the configuration");
				sender.sendMessage("§e§l> §8/gb truesight §7 - Toggle Ghostblock visibility");
